          ...
          switch(S108){
            ...
            case 1 : 
              if(bottleAtPos4.getprestatus()){//sysj\controller.sysj line: 53, column: 9
                ...
                int biggest801 = 0;
                if(ends[4]>=biggest801){
                  biggest801=ends[4];
                }
                if(ends[5]>=biggest801){
                  biggest801=ends[5];
                }
                if(biggest801 == 1){
                  active[3]=1;
            ...
            case 2 : 
              if(gripperZAxisLowered.getprestatus()){//sysj\controller.sysj line: 54, column: 9
                ...
                if(ends[7]>=biggest806){
                  biggest806=ends[7];
                }
                if(ends[8]>=biggest806){
                  biggest806=ends[8];
                }
                if(ends[9]>=biggest806){
                  biggest806=ends[9];
                }
                if(biggest806 == 1){
                  active[3]=1;
                ...
                int biggest809 = 0;
                if(ends[4]>=biggest809){
                  biggest809=ends[4];
                }
                if(ends[5]>=biggest809){
                  biggest809=ends[5];
                }
                if(biggest809 == 1){
                  active[3]=1;
                ...
                if(biggest809 == 0){
                  ...
                  int biggest814 = 0;
                  if(ends[6]>=biggest814){
                    biggest814=ends[6];
                  }
                  if(ends[7]>=biggest814){
                    biggest814=ends[7];
                  }
                  if(ends[8]>=biggest814){
                    biggest814=ends[8];
                  }
                  if(ends[9]>=biggest814){
                    biggest814=ends[9];
                  }
                  if(biggest814 == 1){
                    active[3]=1;
            ...
            case 3 : 
              if(gripperTurnFinalPos.getprestatus()){//sysj\controller.sysj line: 64, column: 9
                ...
                int biggest818 = 0;
                if(ends[10]>=biggest818){
                  biggest818=ends[10];
                }
                if(ends[11]>=biggest818){
                  biggest818=ends[11];
                }
                if(ends[12]>=biggest818){
                  biggest818=ends[12];
                }
                if(biggest818 == 1){
                  active[3]=1;
            ...
            case 4 : 
              if(gripperTurnHomePos.getprestatus()){//sysj\controller.sysj line: 82, column: 9
                ...
                if(ends[11]>=biggest831){
                  biggest831=ends[11];
                }
                if(ends[12]>=biggest831){
                  biggest831=ends[12];
                }
                if(biggest831 == 1){
                  active[3]=1;
