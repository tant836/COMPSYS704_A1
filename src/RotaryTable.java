      ...
      switch(S195){
        ...
        case 2 : 
          switch(S67){
            ...
            case 1 : 
              if(bottleAtPos1_RT.getprestatus()){//sysj\controller.sysj line: 32, column: 9
                S67=2;
                active[2]=1;
                ends[2]=1;
                break RUN;
            ...
            case 3 : 
              if(bottleAtPos2_RT.getprestatus()){//sysj\controller.sysj line: 34, column: 9
                S67=4;
                active[2]=1;
                ends[2]=1;
                break RUN;
            ...
            case 5 : 
              if(bottleAtPos3_RT.getprestatus()){//sysj\controller.sysj line: 38, column: 9
                S67=6;
                active[2]=1;
                ends[2]=1;
                break RUN;
            ...
            case 6 : 
              if(doneAtPos3.getprestatus()){//sysj\controller.sysj line: 41, column: 9
                S67=7;
            ...
            case 7 : 
              if(bottleAtPos4_RT.getprestatus()){//sysj\controller.sysj line: 42, column: 9
                S67=8;
                active[2]=1;
                ends[2]=1;
                break RUN;
            ...
            case 8 : 
              if(doneAtPos4.getprestatus()){//sysj\controller.sysj line: 45, column: 9
                S67=9;
                rotaryTableTrigger.setPresent();//sysj\controller.sysj line: 47, column: 4
                currsigs.addElement(rotaryTableTrigger);
                active[2]=1;
                ends[2]=1;
                break RUN;
            ...
            case 9 : 
              if(bottleAtPos5.getprestatus()){//sysj\controller.sysj line: 46, column: 9
                S67=0;
                active[2]=1;
                ends[2]=1;
                break RUN;
